...
public class MoveList : MonoBehaviour {
    ...
    public static List<string> GetAllMoves(Type pieceClass) {
        ...
        // List<MethodInfo> methods = pieceClass.GetMethods(BindingFlags.Instance |
        //                                                  BindingFlags.Public |
        //                                                  BindingFlags.DeclaredOnly)
        //     .Where(s => !s.IsSpecialName).ToList();
        // List<string> methodNames = methods.Select(s => s.Name).ToList();
        //
        //
        //
        // return methodNames;
